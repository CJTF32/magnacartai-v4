...
// .wrangler/tmp/pages-IuFu3I/functionsWorker-0.02565962617057438.mjs
...
__name2(getDelegateInfo, "getDelegateInfo");
...
var PHASES = {
  convening: {
    ...
    instruction: /* @__PURE__ */ __name2((state) => `This is the CONVENING phase. Turn ${state.phaseTurns + 1} of maximum 4.
...
Delegates who have spoken: ${[...new Set((state.messages || []).filter((m) => m.phase === "convening").map((m) => m.agentName))].join(", ") || "none yet"}`, "instruction")
  ...
  agenda: {
    ...
    instruction: /* @__PURE__ */ __name2((state) => `This is the AGENDA SETTING phase. Turn ${state.phaseTurns + 1} of maximum 8.
...
Current proposed agenda items: ${(state.agenda || []).join(" | ") || "none yet"}`, "instruction")
  ...
  drafting: {
    ...
    instruction: /* @__PURE__ */ __name2((state) => {
...
You are judging proposals for: "${item}"`;
  ...
  ratification: {
    ...
    instruction: /* @__PURE__ */ __name2(() => `This is the RATIFICATION phase.
...
__name2(shuffleFromSeed, "shuffleFromSeed");
...
__name2(getTensionInjector, "getTensionInjector");
...
__name2(buildDraftSummary, "buildDraftSummary");
...
__name2(truncateToWords, "truncateToWords");
...
__name2(parseAgentResponse, "parseAgentResponse");
...
__name2(extractAgenda, "extractAgenda");
...
__name2(checkPhaseTransition, "checkPhaseTransition");
...
__name2(updateScores, "updateScores");
...
__name2(callAnthropic, "callAnthropic");
...
__name2(callMistral, "callMistral");
...
__name2(callExternal, "callExternal");
var routes = [
  {
...
// .wrangler/tmp/bundle-jUasec/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-jUasec/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.02565962617057438.js.map
